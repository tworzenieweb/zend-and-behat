...
class PublisherTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Application\\Model\\Publisher');
    ...
    {
        $this->addRelation('Book', 'Application\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), null, null, 'Books');
    } // buildRelations()
