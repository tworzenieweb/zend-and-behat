...
use Application\Model\map\BookTableMap;
...
abstract class BaseBookPeer
{
    ...
    const OM_CLASS = 'Application\\Model\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Application\\Model\\map\\BookTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Application\Model\map\BookTableMap());
      }
    }
