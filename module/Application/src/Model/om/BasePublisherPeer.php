...
use Application\Model\map\PublisherTableMap;
...
abstract class BasePublisherPeer
{
    ...
    const OM_CLASS = 'Application\\Model\\Publisher';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Application\\Model\\map\\PublisherTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePublisherPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Application\Model\map\PublisherTableMap());
      }
    }
